...
local tray_toggle = helpers.margin(icon, 4, 4, 2, 2)
local systray = helpers.margin({ base_size = 22, widget = wibox.widget.systray }, 5, 5, 0, 0, false)
local togglableSystray = helpers.cbackground({ systray, tray_toggle, layout = wibox.layout.fixed.horizontal }, helpers.rrect(4), colors.crust)
